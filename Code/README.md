...
===================
You need to do a global find/replace for aeonlabs.serenity and change it to your own namespace. Google requires that this be unique, and I've already got this namespace, so do something like com.yourcompany.yourapp
